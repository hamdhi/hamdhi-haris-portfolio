  ...
  <div className="relative p-1 bg-gradient-to-br from-cyan-400/20 to-purple-600/20 rounded-sm">
    ...
    <div className="relative w-64 h-64 md:w-96 md:h-96 overflow-hidden bg-slate-900 shadow-2xl">
      ...
      <section id="stack" className="relative z-10 max-w-7xl mx-auto px-6 py-32">
        ...
        <TechCard name="Java" icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg" tags="JDK 21 / OOP" />
        <TechCard name="Spring Boot" icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/spring/spring-original.svg" tags="REST / JPA / Security" />
        <TechCard name="Supabase" icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/supabase/supabase-original.svg" tags="Database / Auth" />
        <TechCard name="Next.js" icon="https://cdn.simpleicons.org/nextdotjs/white" tags="SSR / App Router" />
        <TechCard name="TypeScript" icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/typescript/typescript-original.svg" tags="Type Safety" />
        <TechCard name="HTML5" icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg" tags="Structure" />
        <TechCard name="CSS3" icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-original.svg" tags="Flex / Grid" />
        <TechCard name="MySQL" icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg" tags="RDBMS / SQL / Indexing" />
        <TechCard name="HeidiSQL" icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original-wordmark.svg" tags="DB Management / SQL UI" />
        <TechCard name="DBeaver" icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original.svg" tags="Universal DB Tool" />
        <TechCard name="VS Code" icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vscode/vscode-original.svg" tags="Code Editor / Extensions" />
        <TechCard name="IntelliJ IDEA" icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/intellij/intellij-original.svg" tags="Java IDE / JetBrains" />
        <TechCard name="MongoDB" icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mongodb/mongodb-original.svg" tags="NoSQL / BSON / Aggregation" />
        </div>
      </section>
