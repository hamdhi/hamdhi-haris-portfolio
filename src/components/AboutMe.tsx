    ...
    <section id="about" className="relative z-10 max-w-7xl mx-auto px-6 py-24">
      ...
      >
        ...
        <div className="relative z-10 grid lg:grid-cols-3 gap-12 mb-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-4 text-slate-300 leading-relaxed text-lg">
              <p>
                ...
                <span className="text-[#2F9A58] font-mono"> Java</span> and 
                <span className="text-[#2F9A58] font-mono"> Spring Boot</span>, optimizing system performance through clean design patterns.
              </p>
              <p>
              ...
              <p>
                Outside of code, I am deeply interested in <span className="text-[#2F9A58]/80 italic">superhero universes</span> and competitive <span className="text-[#2F9A58]/80 italic">video games</span>.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 justify-center">
            {stats.map((stat, i) => (
              ...
              >
                <div className="flex items-center gap-3 text-[#2F9A58] mb-2">
        ...
        <motion.div 
          ...
          className="relative mt-8 py-6 px-4 rounded-xl border-2 border-dashed border-[#2F9A58]/30 bg-[#2F9A58]/5 overflow-hidden group"
        >
          {/* Scanning Animation Effect */}
          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#2F9A58]/10 to-transparent -translate-x-full group-hover:animate-[shimmer_2s_infinite] transition-transform" />
          ...
          <div className="relative z-10 flex flex-col items-center justify-center gap-2 text-center">
            <div className="flex items-center gap-3 mb-1">
              <span className="relative flex h-3 w-3">
                ...
                <span className="relative inline-flex rounded-full h-3 w-3 bg-[#2F9A58]"></span>
              </span>
              <span className="text-xs font-mono text-[#2F9A58] uppercase tracking-[0.3em] font-black">
                System_Status
              </span>
            </div>
            
            <h4 className="text-2xl md:text-4xl font-black text-white uppercase tracking-tighter drop-shadow-[0_0_15px_rgba(47,154,88,0.5)]">
              Open to <span className="text-[#2F9A58]">Collaborations</span> & Internships
            </h4>
