...
export default function Projects() {
  return (
   <section id="projects" className="relative z-10 max-w-7xl mx-auto px-6 py-32">
           ...
           <ProjectCard projectName="OpenEdu" description="Online tuition marketplace focusing on mentor matchmaking and secure payments." learned="Mastered Java Spring Boot layered architecture and handled complex PostgreSQL relational mapping for tutor schedules." technologies={["Java", "Spring", "PostgreSQL"]} imageUrl="/projects/openedu.jpg" githubUrl="https://github.com/..." />
           <ProjectCard projectName="OpenEdu" description="Online tuition marketplace focusing on mentor matchmaking and secure payments." learned="Mastered Java Spring Boot layered architecture and handled complex PostgreSQL relational mapping for tutor schedules." technologies={["Java", "Spring", "PostgreSQL"]} imageUrl="/projects/openedu.jpg" githubUrl="https://github.com/..." />
           <ProjectCard projectName="OpenEdu" description="Online tuition marketplace focusing on mentor matchmaking and secure payments." learned="Mastered Java Spring Boot layered architecture and handled complex PostgreSQL relational mapping for tutor schedules." technologies={["Java", "Spring", "PostgreSQL"]} imageUrl="/projects/openedu.jpg" githubUrl="https://github.com/..." />
