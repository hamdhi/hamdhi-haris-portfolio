        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <div className="mb-4">
              ...
              <div className="min-h-[60px] sm:min-h-[70px] md:min-h-[80px] lg:min-h-[100px] flex justify-center md:justify-start">
                <motion.span 
                  ...
                  className="
                  bg-gradient-to-r from-[#2F9A58] via-[#80EBA9] to-[#2F9A58] bg-[length:200%_auto] bg-clip-text text-transparent 
          ...
          >
            <motion.div 
              ...
              className="relative p-1 bg-gradient-to-br from-[#2F9A58]/20 to-[#2F9A58]/5 rounded-sm"
            >
