        ...
        <div>
          ...
          <div className="space-y-4 mono text-sm text-slate-500 mb-10">
            ...
            <p className="flex items-center gap-2">
              {`> Status: `} 
              <span className="text-accent animate-pulse">Ready to Scale</span>
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-4">
            <a 
              href={`mailto:${email}`}
              className="flex items-center gap-2 px-4 py-2.5 bg-slate-100 dark:bg-white/5 hover:bg-accent/10 border border-slate-200 dark:border-white/10 hover:border-accent/50 rounded-lg text-slate-600 dark:text-slate-300 hover:text-accent transition-all font-mono text-xs shadow-sm hover:shadow-[0_0_15px_hsla(var(--accent-hue),89%,48%,0.2)]"
            >
              <Mail size={16} /> EMAIL
            </a>
            <a 
